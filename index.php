	...
	<div class="carousel-inner">
		...
		<div class="item active">
			...
			<div class="carousel-caption">
				<a href="registrationform.php"><h2 style="color: white;"><mark>Register Now</mark></h2></a>
			</div>
		</div>
		<div class="item">
	...
	<div class="row">
		<div class="col-lg-12 text-center">
			<h1 class="page-header">
				...
				<br>
				<h4>Devlop By: Darshan Deshmukh, Atharva Banchhode, Yash Awachare, Vaibhav Deore.</h4>
            </h1>
        </div>
	</div>
</div>
